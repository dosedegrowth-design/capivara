...
export const PRODUTOS_VEICULAR_AVULSO: ProdutoAvulso[] = [
  ...
  {
    id: "veicular-avulso-rastreamento",
    categoria: "veicular",
    nome: "Rastreamento do Veículo",
    descricao: "Por onde o veículo passou: radares, pátios e indícios de fraude.",
    bullets: [
      "Passagens capturadas com data, hora e local",
      "Pátios em que o veículo foi registrado",
      "Indícios de fraude identificados",
      "Consolidação de registros disponíveis",
    ],
    publicoAlvo: "Seguradora, investigação patrimonial e recuperação de veículo.",
    precoB2C_centavos: 24999,
    precoB2B_centavos: 14999,
    apisIncluidas: ["rastreamento-veicular", "placa-basica"],
    custoApiReal_centavos: 8721,
    icon: "Radar",
  },
  {
