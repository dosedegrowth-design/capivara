...
export const PRODUTOS_VEICULAR_AVULSO: ProdutoAvulso[] = [
  ...
  },
  {
    ...
    categoria: "veicular",
    nome: "Multas e Debitos",
    descricao: "IPVA, licenciamento, multas e DPVAT — com codigo de barras pra pagar.",
    bullets: [
      "IPVA em aberto (ano e valor)",
      "Licenciamento pendente",
      "Multas com valor e situacao",
      "DPVAT e demais taxas",
      "Codigo de barras pra pagamento (conforme o estado)",
    ],
    publicoAlvo: "Quem vai comprar ou transferir e precisa saber o que esta devendo.",
    precoB2C_centavos: 1999,
    precoB2B_centavos: 1099,
  ...
  },
  {
    ...
    categoria: "veicular",
    nome: "Multas RENAINF",
    descricao: "Todas as infracoes de transito registradas na base nacional.",
    bullets: [
      "Numero do auto de infracao",
      "Data, hora e local da autuacao",
      "Orgao autuador",
      "Codigo e descricao da infracao",
      "Valor e situacao do debito",
    ],
    publicoAlvo: "Comprador que quer ver o historico completo de multas antes de assumir o carro.",
    precoB2C_centavos: 1999,
    precoB2B_centavos: 1099,
  ...
  },
  {
    ...
    categoria: "veicular",
    nome: "Restricoes RENAJUD",
    descricao: "Bloqueios judiciais de circulacao, transferencia ou licenciamento.",
    bullets: [
      "Tipo de restricao judicial",
      "Data de inclusao",
      "Processo e vara responsavel (quando disponivel)",
      "Se ha bloqueio de transferencia",
    ],
    publicoAlvo: "Quem vai transferir o veiculo e precisa saber se ha bloqueio judicial.",
    precoB2C_centavos: 1999,
    precoB2B_centavos: 1099,
  ...
  },
  {
    ...
    categoria: "veicular",
    nome: "ATPV-e (2a via)",
    descricao: "Segunda via da Autorizacao para Transferencia de Propriedade eletronica.",
    bullets: [
      "Documento ATPV-e oficial",
      "Dados do veiculo e do proprietario",
      "Pronto pra usar na transferencia",
    ],
    publicoAlvo: "Quem perdeu o ATPV-e e precisa da segunda via pra fechar a transferencia.",
    precoB2C_centavos: 2499,
    precoB2B_centavos: 1399,
  ...
  },
  {
    ...
    descricao: "Onde o veiculo passou por radares, com mapa e geolocalizacao.",
    bullets: [
    ...
    publicoAlvo: "Quem precisa confirmar deslocamento do veiculo (frota, seguro, disputa).",
    precoB2C_centavos: 1299,
    precoB2B_centavos: 699,
